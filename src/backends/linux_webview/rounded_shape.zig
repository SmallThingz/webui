...
pub fn applyRoundedWindowShape(
    ...
    symbols.setRoundedRegion(window_widget, region);
}
...
fn buildRoundedRegion(
    ...
    if (!symbols.supportsRoundedShape()) return null;
